# Michigan Big Tree Map
# Created 6/21/2022 by Aidan Morales
# Modified 11/02/2023 by Aidan Morales
...
bscols(
  widths = c(1, 11),
  "",
  htmltools::h3("Michigan Big Tree Map", style = "font-style:italic;")
)
...
map_df %>%
  ...
  addProviderTiles(providers$Stadia.StamenToner, group = "Simple") %>%
  ...
  addLegend(
    ...
    colors = c("lightgray", "lightblue", "lightgreen", "pink"),
